...
"""
The `UnorderedList` class organizes items as a bulleted list.

Each item in the list is preceded by a bullet point (e.g., •, *, or a custom symbol),
providing a simple way to present non-sequential information clearly. This class is
...
class UnorderedList(List):
    ...
    def __init__(self, background_color: typing.Optional[Color] = ..., border_color: typing.Optional[Color] = ..., border_dash_pattern: typing.List[int] = ..., border_dash_phase: int = ..., border_width_bottom: int = ..., border_width_left: int = ..., border_width_right: int = ..., border_width_top: int = ..., horizontal_alignment: LayoutElement.HorizontalAlignment = ..., margin_bottom: int = ..., margin_left: int = ..., margin_right: int = ..., margin_top: int = ..., padding_bottom: int = ..., padding_left: int = ..., padding_right: int = ..., padding_top: int = ..., vertical_alignment: LayoutElement.VerticalAlignment = ...) -> None:
        """
        Initialize a new `UnorderedList` object for rendering list elements in a PDF.
