...
class Table(LayoutElement):
    ...
    class TableCell(LayoutElement):
        ...
        """
        def __init__(self, e: LayoutElement, background_color: typing.Optional[Color] = ..., border_color: typing.Optional[Color] = ..., border_dash_pattern: typing.List[int] = ..., border_dash_phase: int = ..., border_width_bottom: int = ..., border_width_left: int = ..., border_width_right: int = ..., border_width_top: int = ..., column_span: int = ..., horizontal_alignment: LayoutElement.HorizontalAlignment = ..., margin_bottom: int = ..., margin_left: int = ..., margin_right: int = ..., margin_top: int = ..., padding_bottom: int = ..., padding_left: int = ..., padding_right: int = ..., padding_top: int = ..., row_span: int = ..., vertical_alignment: LayoutElement.VerticalAlignment = ...) -> None:
            """
    ...
    def set_padding_on_all_cells(self, padding_bottom: int, padding_left: int, padding_right: int, padding_top: int) -> Table:
        """
    ...
    def striped(self, even_row_color: typing.Optional[Color] = ..., odd_row_color: typing.Optional[Color] = ...) -> Table:
        """
