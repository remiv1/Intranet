...
"""
Represents a text area form element in a PDF document.

The `TextArea` class is used to create and manage multi-line text input fields
within PDF forms. Text areas allow users to enter larger blocks of text, making
...
class TextArea(FormField):
    ...
    a single-line text field can provide.
    """
    def __init__(self, background_color: typing.Optional[Color] = ..., border_color: typing.Optional[Color] = ..., border_dash_pattern: typing.List[int] = ..., border_dash_phase: int = ..., border_width_bottom: int = ..., border_width_left: int = ..., border_width_right: int = ..., border_width_top: int = ..., default_value: str = ..., field_name: typing.Optional[str] = ..., font_color: Color = ..., font_size: int = ..., horizontal_alignment: LayoutElement.HorizontalAlignment = ..., margin_bottom: int = ..., margin_left: int = ..., margin_right: int = ..., margin_top: int = ..., number_of_lines: int = ..., padding_bottom: int = ..., padding_left: int = ..., padding_right: int = ..., padding_top: int = ..., value: str = ..., vertical_alignment: LayoutElement.VerticalAlignment = ...) -> None:
        """
        Initialize a TextArea component, representing a text area form field that can be inserted into a PDF document.

        :param background_color:        Optional; The background color of the text area. If None, the background is transparent.
        ...
        :param default_value:           The default text that appears in the text area when no user input is provided.
        :param field_name:              Optional; The name of the text field. This can be used to identify the field within the PDF.
        :param font_color:              The color of the text within the text area. Defaults to black.
        :param font_size:               The size of the font used for the text within the text area. Defaults to 12.
        :param horizontal_alignment:    Defines the horizontal alignment of the text. Can be LEFT, CENTER, or RIGHT. Defaults to LEFT.
        :param margin_bottom:           The bottom margin of the text area in pixels. Defaults to 0.
        :param margin_left:             The left margin of the text area in pixels. Defaults to 0.
        :param margin_right:            The right margin of the text area in pixels. Defaults to 0.
        :param margin_top:              The top margin of the text area in pixels. Defaults to 0.
        :param number_of_lines:         The number of visible lines in the text area. Defaults to 5.
        :param padding_bottom:          The bottom padding inside the text area in pixels. Defaults to 0.
        :param padding_left:            The left padding inside the text area in pixels. Defaults to 0.
        :param padding_right:           The right padding inside the text area in pixels. Defaults to 0.
        :param padding_top:             The top padding inside the text area in pixels. Defaults to 0.
        :param value:                   The current value (text content) of the text area. Defaults to an empty string.
