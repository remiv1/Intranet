...
class TextBox(FormField):
    ...
    capturing brief inputs such as names, email addresses, or other concise data.
    """
    def __init__(self, background_color: typing.Optional[Color] = ..., border_color: typing.Optional[Color] = ..., border_dash_pattern: typing.List[int] = ..., border_dash_phase: int = ..., border_width_bottom: int = ..., border_width_left: int = ..., border_width_right: int = ..., border_width_top: int = ..., default_value: str = ..., field_name: typing.Optional[str] = ..., font_color: Color = ..., font_size: int = ..., horizontal_alignment: LayoutElement.HorizontalAlignment = ..., margin_bottom: int = ..., margin_left: int = ..., margin_right: int = ..., margin_top: int = ..., max_size: typing.Optional[int] = ..., padding_bottom: int = ..., padding_left: int = ..., padding_right: int = ..., padding_top: int = ..., value: str = ..., vertical_alignment: LayoutElement.VerticalAlignment = ...) -> None:
        """
