"""
Module des utilitaires pour l'application, incluant des fonctions pour la gestion des données
JSON et des constantes utilisées dans l'application.
"""
...
@overload
def get_jsoned_datas(
    file: str, level_one: str, *, dumped: Literal[True]) -> str: ...
@overload
def get_jsoned_datas(
    file: str, level_one: str, level_two: str, *, dumped: Literal[True]) -> str: ...
@overload
def get_jsoned_datas(
    file: str, level_one: str, *, dumped: Literal[False] = False) -> List[Dict[str, Any]]: ...
@overload
def get_jsoned_datas(
    file: str, level_one: str, level_two: str, *, dumped: Literal[False] = False
    ) -> Union[Dict[str, Any], List[Dict[str, Any]]]: ...

def get_jsoned_datas(
    file: str, level_one: str, level_two: Optional[str] = None, dumped: bool = False
    ...
    Args:
        ...
        dumped (Optional[bool]): Si True, retourne une chaîne JSON, sinon retourne
                                 un dictionnaire ou une liste.
    Returns:
        str ou Dict[str, Any] ou List[Any]:
            - Les menus au format JSON ou en tant que structure de données Python.
    """
